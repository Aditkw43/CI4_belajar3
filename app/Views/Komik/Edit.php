...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <!-- Form -->
            <form action="/komik/update/<?= $komik['id']; ?>" method="POST" class="d-inline" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group mb-3">
                            <input type="file" class="form-control <?= ($validation->hasError('sampul')) ? 'is-invalid' : ''; ?>" id="sampul" name="sampul" onchange="previewImg()" placeholder="Kosong">
                            <div id="validationServer03Feedback" class="invalid-feedback">
            ...
            <br>
            <a href="/komik/<?= $komik['judul']; ?>">Kembali ke Detail Komik</a>
        </div>
    </div>
</div>
